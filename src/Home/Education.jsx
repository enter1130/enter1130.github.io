  ...
  const education=[
    {
      ...
      "color":'#f50',
      "content":'我的研究方向著重於結合圖神經網路（GNN）與階層式結構資料，應用於產品異常偵測。針對具有多層級、複雜依賴關係的產品結構（例如零件樹狀圖），設計並實作出一套基於 GNN 的異常偵測模型，能夠捕捉跨層級的結構特徵與節點間的相互影響，精確識別潛在的異常產品或異常組件。在技術實作上，採用 Python 作為主要開發語言，利用 PyTorch 深度學習框架實現模型建構與訓練，並結合 CUDA 技術加速圖資料的平行運算，顯著提升大規模資料的處理效能。模型同時融合圖卷積與注意力機制，強化對異質結構資料的特徵表徵能力。本研究成果有助於實現產品製造與品質管理中的即時異常預警，協助企業及早發現潛在風險，進一步應用於智慧製造、品質監控及供應鏈風險管理，展現圖神經網路在產品異常偵測與階層式結構資料分析中的高度應用潛力。'
    },{
      "name":'工業與資訊管理 學士',
      "school":'國立成功大學',
      "img":'https://img.icons8.com/?size=100&id=23319&format=png&color=000000',
