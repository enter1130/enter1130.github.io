  ...
  return (
    <div className="animate__animated animate__fadeIn animate__faster" style={{height: '100%', overflowY:'auto',overflowX:'hidden'}}>
      <Paragraph style={{padding:`${viewPadding}px`}}>
        ...
        <div className="text-muted" style={{textJustify:'justify',fontSize:'clamp(12px, 2.5vw, 16px)'}}>
          碩士就讀於國立成功大學資訊管理研究所，專注於圖神經網路（GNN）及異常偵測技術，具備資料前處理、模型建構、性能分析與優化的實作經驗，致力於將先進的人工智慧技術應用於實際問題解決，提升系統效能與準確性。
          <br />除研究領域外，亦具備網站開發及 IT 管理經驗，協助企業進行電腦設備維護、帳號與權限管理、資訊安全防護及資源監控，確保內部系統穩定運作。熟悉 GCP 雲端平台之架構設計與資源部署，具備跨平台服務整合能力。
          <br />技術專長涵蓋 Python、PyTorch、SQL 等程式與資料處理工具，並熟悉 Git、Docker 等開發與版本控制工具，能靈活運用於各項系統開發與維護工作。
        </div>
        <Divider />
